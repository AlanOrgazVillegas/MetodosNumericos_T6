 ...
 * Descripción del ejemplo
    ...
    Función: x^4+7x^3-7  Limites: A:-7  B:1    Error: 0.0001  Iteraciones: 6
...
public class Biseccion3 {
    public static void main(String[] args) {
        System.out.println(" EJECICIO 3 METODO DE BISECCION ");
        ...
        // Leer el valor de tolerancia desde el usuario
    ...
    public static double func(double x) {
        return Math.pow(x,4) + 7 * Math.pow(x, 3) - 7;
