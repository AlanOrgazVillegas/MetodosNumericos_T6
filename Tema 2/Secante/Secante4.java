 ...
 * Descripción del ejemplo
    ...
    Función: -1.047x^3+9.42x^2-100    Limites A: 6 B: 8    Error: 0.0001    Iteraciones: 6
...
public class Secante4 {
    public static void main(String[] args) {
        System.out.println(" EJEMPLO 4 METODO DE SECANTE ");
    ...
    public static double func(double x) {
        return -1.047 * Math.pow(x, 3) + 9.42 * Math.pow(x, 2) - 100;
    }
}
