 ...
 * Descripción del ejemplo
    ...
    Función: x^2-2  Limites: A: 1  B: 2    Error: 0.0001    Iteraciones: 6

    Implemetación (resultado a 5 cifras significativas)
...
public class ReglaFalsa2 {
    public static void main(String[] args) {
        ...
        System.out.println("EJERCICIO 2 DE METODO DE LA REGLA FALSA ");
